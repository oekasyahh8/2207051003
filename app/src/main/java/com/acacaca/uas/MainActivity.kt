...
fun LoginScreen(onLogin: () -> Unit = {}) {
    ...
    Column(
        ...
        Image(
            painter = painterResource(R.drawable.jijul), // Gambar latar belakang atas
        ...
        Column(
            ...
            Image(
                painter = painterResource(R.drawable.liverpoll), // Gambar logo
                contentDescription = null,
            ...
            Text("Azizul Hakim", fontSize = 24.sp, color = Color.Black)
...
fun MainScreen() {
    Column(
        ...
        Image(
            painter = painterResource(R.drawable.liverpoll),
            contentDescription = null,
        ...
        Column(
            ...
            Row(
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    Image(painter = painterResource(R.drawable.liverpoll), contentDescription = null)
                    Text("LIVERPOLL", color = Color.Black)
                }
                Image(painter = painterResource(R.drawable.ic_launcher_background), contentDescription = null)
                Column(horizontalAlignment = Alignment.CenterHorizontally) {
                    Image(painter = painterResource(R.drawable.barca), contentDescription = null)
                    Text("BARCELONA", color = Color.Black)
                }
            }
            ...
            Row(
                ...
                Image(painter = painterResource(R.drawable.jijul), contentDescription = null, modifier = Modifier.size(100.dp))
                Image(painter = painterResource(R.drawable.ic_launcher_background), contentDescription = null, modifier = Modifier.size(100.dp))
            }
